...
def concat(element):
	...
	commands = """
	cp /pylon5/bi4s86p/phuong/geographus.genome/rnaseq/3assembly/{index}_trinity.Trinity.fasta ./
	mv {index}_trinity.Trinity.fasta {index}_contigs.fasta
	/home/phuong/CAP3/cap3 {index}_contigs.fasta > {index}.cap3.out
	...
	cp {index}.* /pylon5/bi4s86p/phuong/geographus.genome/rnaseq/4clustering
	cp {index}_* /pylon5/bi4s86p/phuong/geographus.genome/rnaseq/4clustering
	""".format(**variables)
