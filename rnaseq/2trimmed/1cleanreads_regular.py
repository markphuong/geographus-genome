...
def align(element):
	...
	commands = """
	cp /pylon5/bi4s86p/phuong/geographus.genome/rnaseq/1rename/{read1} ./
	cp /pylon5/bi4s86p/phuong/geographus.genome/rnaseq/1rename/{read2} ./
	java -jar $TRIMMOMATIC_HOME/trimmomatic-0.36.jar PE -threads 12 -phred33 {read1} {read2} {read1out} {read1unpairedout} {read2out} {read2unpairedout} ILLUMINACLIP:{adfile}:2:40:15 SLIDINGWINDOW:4:20 MINLEN:36 LEADING:15 TRAILING:15 > {sampleID}.trimm 2> {sampleID}.trimmerr
        ...
        cp {sampleID}.trinity.left.fq /pylon5/bi4s86p/phuong/geographus.genome/rnaseq/2trimmed
        cp {sampleID}.trinity.right.fq /pylon5/bi4s86p/phuong/geographus.genome/rnaseq/2trimmed
	cp {sampleID}.trimm /pylon5/bi4s86p/phuong/geographus.genome/rnaseq/2trimmed
	cp {sampleID}.trimmerr /pylon5/bi4s86p/phuong/geographus.genome/rnaseq/2trimmed
	""".format(**variables)
