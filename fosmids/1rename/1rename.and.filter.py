...
def concat(element):
	...
	variables = dict(
	sampleID = element,
	read1 = element + '_150423_D00550_0250_AC6C42ANXX_6_1.txt.gz',
	read2 = element + '_150423_D00550_0250_AC6C42ANXX_6_2.txt.gz')




	commands = """
	cp /pylon5/bi4s86p/phuong/geographus.genome/0data/{read1} ./
	cp /pylon5/bi4s86p/phuong/geographus.genome/0data/{read2} ./
	...
	cp {sampleID}.R1.renamed.fq /pylon5/bi4s86p/phuong/geographus.genome/1rename/
	cp {sampleID}.R2.renamed.fq /pylon5/bi4s86p/phuong/geographus.genome/1rename/
	""".format(**variables)
